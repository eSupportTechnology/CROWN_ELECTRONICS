                                ...
                                <div
                                    ...
                                    <div class="mt-16 product-card__content">
                                        <h6 class="mt-12 mb-8 text-lg title fw-semibold">
                                            <a href="{{ url('/product-details/' . $product->product_id) }}"
                                                class="link text-line-2" tabindex="0">{{ $product->product_name }}</a>
                                        </h6>
                                        <div class="gap-6 mt-16 mb-20 flex-align">
                                            @if ($product->total_reviews != 0)
                                                <div class="gap-2 rating-info d-flex">
                                                    ...
                                                    @endif
                                                    <span
                                                        class="text-xs text-gray-500 fw-medium">{{ number_format($product->average_rating, 1) }}</span>
                                                    &nbsp;<span
                                                        class="text-xs text-gray-500 fw-medium">({{ $product->total_reviews }})</span>
                                                </div>
                                            @endif
                                        ...
                                        <div class="mt-8 mb-20 product-card__price">
                                            <span
                                                class="text-heading text-md fw-semibold ">{{ $product->currency->symbol ?? 'Rs' }}
                                        ...
                                        <a href="#"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#cartModal_{{ $product->product_id }}"
                                            ...
                                            <div class="modal-body">
                                                <div class="row gx-5">
                                                    ...
                                                    <main class="col-lg-7">
                                                        ...
                                                        <p class="product-description">{{ $product->product_description }}
                                                        </p>
                                                        ...
                                                        @else
                                                            <p class="mb-5 text-danger">Please <a
                                                                    href="{{ route('login') }}">log in</a> to add items to the
                                                                cart.</p>
                                                        @endauth
                                                    </main>
                                                </div>
