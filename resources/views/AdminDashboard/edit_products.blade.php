                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="product_name"
                                value="{{ old('product_name', $product->product_name) }}" placeholder="Type here"
                            ...
                            @foreach ($product->variations as $index => $variation)
                                <div class="row mb-3 variation-row">
                                    <div class="col-lg-4">
                                        ...
                                        <select name="variations[{{ $index }}][type]" class="form-select"
                                            onchange="toggleColorInput(this)">
                                            <option value="size" {{ $variation->type == 'size' ? 'selected' : '' }}>Size
                                            </option>
                                            <option value="color" {{ $variation->type == 'color' ? 'selected' : '' }}>
                                                Color</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="form-label">Value</label>
                                        <input type="text" name="variations[{{ $index }}][value]"
                                            class="form-control"
                                            value="{{ $variation->type == 'color' ? '' : $variation->value }}" />
                                        <input type="color" name="variations[{{ $index }}][hex_value]"
                                            class="form-control color-input"
                                            style="display: {{ $variation->type == 'color' ? 'block' : 'none' }};"
                                            value="{{ $variation->hex_value }}" />
                                    </div>
                                    <div class="col-lg-3">
