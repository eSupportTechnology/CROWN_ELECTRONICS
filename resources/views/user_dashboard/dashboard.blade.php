            ...
            <div id="notification_banner"></div>
                ...
                <div class="site-common-con">
                    <div class="mobile-profile-nav">
                        <div class="profile-menu-overlay" style="display: none;"></div>
                        <div class="div">My Profile</div>
                        <div class="div ms-auto">
                            <div class="hamburger-menu">
                                <div class="profile-mobi-btn">
                                ...
                                <div class="menu__box myprofile-nav">

                                    <div class="close-myprofile">
                                        <i class="fa-solid fa-xmark"></i>
                                    </div>

                                    <div class="mobi-profile-link">
                                        <ul>
                                            <li class="welcome">
                                            ...
                                            <li><a class=" d-block"
                                                    href="https://buyabans.com/customer/account/profile"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/dashboard.svg">Dashboard</a>
                                            </li>
                                            <li><a class="d-block"
                                                    href="https://buyabans.com/customer/account/profile/edit"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/info.svg">Account
                                                    Information</a></li>

                                            <li><a class="d-block"
                                                    href="https://buyabans.com/customer/account/orders/my-orders"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/delivery-box.svg">My
                                                    Orders</a></li>
                                            <li><a class="d-block"
                                                    href="https://buyabans.com/customer/account/wishlist"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/favourite.svg">My
                                                    Wishlist</a></li>
                                            <li><a class="d-block"
                                                    href="https://buyabans.com/customer/account/addresses"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/location.svg">Address
                                                    Book</a></li>


                                            <li><a class="d-block"
                                                    href="https://buyabans.com/customer/account/loyalty"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/guarantee.svg">Loyalty</a>
                                            </li>
                                            <li><a class="d-block" href="#"><img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/return.svg">Return
                                                    Requests</a></li>
                                            <li>
                                                <form id="customerLogout" action="https://buyabans.com/customer/logout"
                                                    method="POST">
                                                    <input type="hidden" name="_token"
                                                        value="0W6UYHT7NpDDvU8nbHLHBdUXbdeUwm5KqkMw9eum"
                                                        autocomplete="off">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                </form>

                                                <a class="d-block" href="https://buyabans.com/customer/logout"
                                                    onclick="if (!window.__cfRLUnblockHandlers) return false; event.preventDefault(); document.getElementById('customerLogout').submit();"
                                                    data-cf-modified-5f515bd59a237a1713a6a7fe-="">
                                                    <img
                                                        src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/logout.svg">Logout
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="site-common-con">
                    <div class="row">
                        <div class="col-xl-3 auth-nav destop-profile-menu">
                            <div class="auth-con-h-auto myprofile-nav p-0">
                                <div class="menu-link">
                                    <div class="icon"></div>
                                </div>
                                <ul class="list-unstyled">
                                    <li class="welcome">
                                        ...
                                        <p class="name"> Anuradha Sampath </p>

                                    </li>
                                    <li><a class="d-block  active "
                                            href="https://buyabans.com/customer/account/profile"><img
                                                src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/dashboard.svg">Dashboard</a>
                                    </li>
                                    ...
                                    <li><a class="d-block "
                                            href="https://buyabans.com/customer/account/orders/my-orders"><img
                                                src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/delivery-box.svg">My
                                            Orders</a></li>
                                    <li><a class="d-block " href="https://buyabans.com/customer/account/wishlist"><img
                                                src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/favourite.svg">My
                                            Wishlist</a></li>
                                    <li><a class="d-block " href="https://buyabans.com/customer/account/addresses"><img
                                                src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/location.svg">Address
                                            Book</a></li>


                                    <li><a class="d-block " href="https://buyabans.com/customer/account/loyalty"><img
                                                src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/guarantee.svg">Loyalty</a>
                                    </li>
                                    <li><a class="d-block " href="#"><img
                                                src="https://buyabans.com/themes/buyabans/assets/images/icon/profile/return.svg">Return
                                    ...
                                    <li>
                                        <form id="customerLogout" action="https://buyabans.com/customer/logout"
                                            method="POST">
                                            <input type="hidden" name="_token"
                                                value="0W6UYHT7NpDDvU8nbHLHBdUXbdeUwm5KqkMw9eum" autocomplete="off">
                                            <input type="hidden" name="_method" value="DELETE">
                                        </form>
                        ...
                        <div class="col-12 col-xl-9">
                            <div class="auth-con">
                                <div class="profile-block">Account Information</div>
                                <div class="row acc-info-align">
                                    <div class="col-sm-6">
                                        <div class="acc-headding">
                                            <h4>Contact Information</h4>
                                        </div>
                                        <div class="account-data">
                                            <p>Anuradha Sampath</p>
                                            <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                    data-cfemail="670609121506030f0614060a1706130f515327000a060e0b4904080a">[email&#160;protected]</a>
                                            </p>
                                        </div>

                                        <div class="action-btns">
                                            <a class="btn-profile me-3"
                                                href="https://buyabans.com/customer/account/profile/edit">Edit</a>
                                        </div>
                                    </div>
...
if ($(this).hasClass("select-review")) {
            ...
            if(status == 1){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.get(
                            "https://buyabans.com/customer/account/profile/unsubscribe/" + customerEmail,
                            function(result) {
                                if(result.status){
                                    Swal.fire({
                                        title: 'Success',
                                    ...
                                    Swal.fire({
                                        title: 'Error',
                                        text: 'Somting went wrong, Please try again later...',
                                        icon: 'error',
                                    });
                                }
                            }
                ...
                var redirectTo = "https://buyabans.com/contactus/newsletter-subscription";
    ...
    <script >
        $(document).ready(function() {
            $(".profile-mobi-btn").click(function() {
                $('.menu__box').addClass('profile-menu-show');
                $('.profile-menu-overlay').addClass('d-block')
                $('body').addClass('overflow-hidden');
            });

            $(".close-myprofile").click(function() {
                $('.menu__box').removeClass('profile-menu-show');
                $('.profile-menu-overlay').removeClass('d-block')
                $('body').removeClass('overflow-hidden');
            });

            $(".profile-menu-overlay").click(function() {
    ...
    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="5f515bd59a237a1713a6a7fe-|49" defer></script>
    <script>(function () { function c() { var b = a.contentDocument || a.contentWindow.document; if (b) { var d = b.createElement('script'); d.innerHTML = "window.__CF$cv$params={r:'93b9fc9e0f826700',t:'MTc0NjU1MDMzNC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);"; b.getElementsByTagName('head')[0].appendChild(d) } } if (document.body) { var a = document.createElement('iframe'); a.height = 1; a.width = 1; a.style.position = 'absolute'; a.style.top = 0; a.style.left = 0; a.style.border = 'none'; a.style.visibility = 'hidden'; document.body.appendChild(a); if ('loading' !== document.readyState) c(); else if (window.addEventListener) document.addEventListener('DOMContentLoaded', c); else { var e = document.onreadystatechange || function () { }; document.onreadystatechange = function (b) { e(b); 'loading' !== document.readyState && (document.onreadystatechange = e, c()) } } } })();</script>
