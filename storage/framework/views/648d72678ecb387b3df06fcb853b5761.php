<?php $__env->startSection('content'); ?>
    ...
    <section class="shop py-80">
        <div class="container container-lg">
            ...
            <img src="https://cdn-icons-png.flaticon.com/512/6134/6134065.png" alt="No results" style="max-width: 150px; opacity: 0.7;">
            <h4 class="mt-3 text-muted">No products found</h4>
            <p class="text-secondary">Try changing your search or browsing all categories.</p>
                        ...
                        <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <a href="<?php echo e(url('/product-details/' . $product->product_id)); ?>"
                                        ...
                                        <img src="<?php echo e(asset('storage/' . $product->images->first()->image_path)); ?>"
                                            alt="<?php echo e($product->product_name); ?>" class="product-image">
                                    </a>

                                    <div class="mt-16 product-card__content">
                                        <h6 class="mt-12 mb-8 text-lg title fw-semibold">
                                            <a href="<?php echo e(url('/product-details/' . $product->product_id)); ?>"
                                                class="link text-line-2" tabindex="0"><?php echo e($product->product_name); ?></a>
                                        </h6>
                                        <div class="gap-6 mt-16 mb-20 flex-align">
                                            <?php if($product->total_reviews != 0): ?>
                                                <div class="gap-2 rating-info d-flex">
                                                    ...
                                                    <?php endif; ?>
                                                    <span
                                                        class="text-xs text-gray-500 fw-medium"><?php echo e(number_format($product->average_rating, 1)); ?></span>
                                                    &nbsp;<span
                                                        class="text-xs text-gray-500 fw-medium">(<?php echo e($product->total_reviews); ?>)</span>
                                                </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="mt-8 mb-20 product-card__price">
                                            <span
                                                class="text-heading text-md fw-semibold "><?php echo e($product->currency->symbol ?? 'Rs'); ?>
                                        ...
                                        <a href="#"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#cartModal_<?php echo e($product->product_id); ?>"
                                ...
                                <!-- Cart Modal -->
                                <div class="modal fade" id="cartModal_<?php echo e($product->product_id); ?>" tabindex="-1"
                                            ...
                                            <div class="modal-body">
                                                <div class="row gx-5">
                                                    ...
                                                    <main class="col-lg-7">
                                                        ...
                                                        <p class="product-description"><?php echo e($product->product_description); ?>
                                                        ...
                                                        <div class="mt-8 mb-3 product-price d-flex align-items-center">
                                                            <h6 class="mb-0"><?php echo e($product->currency->symbol ?? 'Rs'); ?>
                                                                ...
                                                                <?php echo e($product->normal_price); ?></h6>
                                                        </div>
                                                        ...
                                                        <?php if(auth()->guard()->check()): ?>
                                                            <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                                                                ...
                                                                <input type="hidden" name="price"
                                                                    value="<?php echo e($product->normal_price); ?>">
                                                                <button type="submit" class="mt-5 btn btn-main w-95">
                                                                    Add To Cart
                                                                </button>
                                                            </form>
                                                        <?php else: ?>
                                                            <p class="mb-5 text-danger">Please <a
                                                                    href="<?php echo e(route('login')); ?>">log in</a> to add items to the
                                                                cart.</p>
                                                        <?php endif; ?>
                                                    </main>
                                                </div>
                    ...
                    <ul class="flex-wrap gap-16 pagination flex-center">
                        <li class="page-item">
                            <a class="border border-gray-100 page-link flex-center text-xxl rounded-8 fw-medium text-neutral-600"
                        ...
                        <?php for($i = 1; $i <= $products->lastPage(); $i++): ?>
                            <li class="page-item <?php echo e($i == $products->currentPage() ? 'active' : ''); ?>">
                                <a class="border border-gray-100 page-link flex-center text-md rounded-8 fw-medium text-neutral-600"
...
<?php echo $__env->make('frontend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\crown elc\CROWN_ELECTRONICS\resources\views/frontend/shop.blade.php ENDPATH**/ ?>