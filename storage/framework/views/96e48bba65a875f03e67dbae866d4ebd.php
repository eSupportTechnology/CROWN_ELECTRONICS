...
<?php $component->withAttributes([]); ?>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        <?php echo e(__("Forgot your password? No worries! Just enter your email below and we'll send you a secure link to reset your password.")); ?>
...
<?php endif; ?>
    ...
    <?php else: ?>
        <div class="mt-4 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('Please check your inbox for the password reset link.')); ?>
...
<?php endif; ?>
<?php /**PATH E:\eSupport Project\CROWN_ELECTRONICS\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>