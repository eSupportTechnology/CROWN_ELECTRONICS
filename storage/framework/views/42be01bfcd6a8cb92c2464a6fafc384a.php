                    ...
                    <div class="row mb-3">
                        <div class="col-6 mb-2">
                            ...
                            <p><strong>Category:</strong> <span
                                    class="badge bg-info text-white"><?php echo e($product->category->name ?? 'N/A'); ?></span></p>
                            <p><strong>Quantity:</strong> <?php echo e($product->quantity); ?></p>
                            <p><strong>Brand:</strong> <?php echo e($product->brand->name ?? 'N/A'); ?></p>
                    ...
                    <div class="d-flex flex-wrap mt-2">
                        <?php if($product->images->isNotEmpty()): ?>
                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" class="img-thumbnail me-2 mb-2"
                                    style="width: 12%;" alt="Product Image" />
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
...
<?php echo $__env->make('AdminDashboard.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\CROWN_ELECTRONICS\CROWN_ELECTRONICS\resources\views/AdminDashboard/product-details.blade.php ENDPATH**/ ?>