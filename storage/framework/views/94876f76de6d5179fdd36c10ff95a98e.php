...
unset($__errorArgs, $__bag); ?>" id="fullName"
                    name="full_name" value="<?php echo e(old('full_name', $user->name)); ?>" placeholder="Enter your full name">
...
unset($__errorArgs, $__bag); ?>" id="email"
                    name="email" value="<?php echo e(old('email', $user->email)); ?>" placeholder="Enter your email">
...
unset($__errorArgs, $__bag); ?>" id="mobile"
                    name="phone_num" value="<?php echo e(old('phone_num', $user->phone)); ?>" placeholder="Enter your mobile number"
...
unset($__errorArgs, $__bag); ?>" id="birthday"
                    name="date_of_birth" value="<?php echo e(old('date_of_birth', $user->dob)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="address"
                    name="address" value="<?php echo e(old('address', $user->address)); ?>" placeholder="Enter your address">
...
<?php echo $__env->make('layouts.user_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eSupport Project\CROWN_ELECTRONICS\resources\views/user_dashboard/edit-profile.blade.php ENDPATH**/ ?>