                ...
                <div class="list-grid-wrapper">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-16 border border-gray-100 product-card h-100 hover-border-main-600 rounded-16 position-relative transition-2" >
                            <a href="<?php echo e(url('/product-details/' . $product->product_id)); ?>" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative" style="height: 270px; background-size: contain;">
                            ...
                            <div class="mt-16 product-card__content">
                                ...
                                <div class="mt-8 mb-20 product-card__price">
                                    <span class="text-heading text-md fw-semibold "><?php echo e($product->currency->symbol ?? 'Rs'); ?> <?php echo e(number_format($product->normal_price, 2)); ?> <span class="text-gray-500 fw-normal">/Qty</span></span>
                                </div>
...
<?php echo $__env->make('frontend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\JOB\esupport\CROWN_ELECTRONICS\resources\views/frontend/shop.blade.php ENDPATH**/ ?>