<?php $__env->startSection('content'); ?>
    <main class="content-container">
        ...
        <style>
            .spacing-top {
            height: 120px; /* Adjust based on desired spacing */
        }
            ...
            <div class="row">
                <div class="col-md-3 terms-nav">
                    <div class="nav flex-column nav-pills" id="v-pills-tab">
                        ...
                        <a class="nav-link  active " id="v-pills-three-tab" href="/return-refund">Return and Refund
                            Policy</a>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="tab-content terms-tab" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade " id="v-pills-two" role="tabpanel" aria-labelledby="v-pills-two-tab">
                            ...
                            <table style="margin-bottom: 1rem;">
                                ...
                                <tr>
                                    <td>Email :</td>
                                    <td><a href="cdn-cgi/l/email-protection.html#1871767e77587a6d61797a79766b367b7775"><span
                                                class="__cf_email__"
                                                data-cfemail="422b2c242d0220373b2320232c316c212d2f">[email&#160;protected]</span></a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('frontend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\CROWN_ELECTRONICS\CROWN_ELECTRONICS\resources\views/frontend/ReturnRefund.blade.php ENDPATH**/ ?>