            ...
            <div class="col-lg-4">
                <div class="contact-box border border-gray-100 rounded-16 px-24 py-40">
                    ...
                    <div class="flex-align gap-16 mb-16">
                        ...
                        <a href="tel:<?php echo e($companySettings->contact); ?>" class="text-md text-gray-900 hover-text-main-600"><?php echo e($companySettings->contact); ?></a>
                    </div>
                    <div class="flex-align gap-16 mb-16">
                        ...
                        <a href="mailto:<?php echo e($companySettings->email); ?>" class="text-md text-gray-900 hover-text-main-600"><?php echo e($companySettings->email); ?></a>
                    </div>
...
<?php echo $__env->make('frontend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\CROWN_ELECTRONICS\CROWN_ELECTRONICS\resources\views/frontend/contact.blade.php ENDPATH**/ ?>