                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input name="regular_price" id="regular_price" placeholder="Rs" type="number"
                                        class="form-control" />
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Normal price <i class="text-danger">*</i></label>
                                    <input name="normal_price" id="normal_price" placeholder="Rs" type="number"
                                        class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input name="com_price" id="com_price" placeholder="Rs" type="number"
...
<?php echo $__env->make('AdminDashboard.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\crown elc\CROWN_ELECTRONICS\resources\views/AdminDashboard/add_products.blade.php ENDPATH**/ ?>