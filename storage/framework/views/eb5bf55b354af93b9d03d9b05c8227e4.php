                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input name="normal_price" id="normal_price"
                                        value="<?php echo e(old('normal_price', $product->normal_price)); ?>" placeholder="Rs"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input name="affiliate_price" id="affiliate_price"
                                        value="<?php echo e(old('affiliate_price', $product->affiliate_price)); ?>" placeholder="Rs"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input name="com_price" id="com_price"
                                        value="<?php echo e(old('commission_price', $product->commission_price)); ?>" placeholder="Rs"
                                        type="number" class="form-control" readonly />
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('AdminDashboard.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\CROWN_ELECTRONICS\CROWN_ELECTRONICS\resources\views/AdminDashboard/edit_products.blade.php ENDPATH**/ ?>