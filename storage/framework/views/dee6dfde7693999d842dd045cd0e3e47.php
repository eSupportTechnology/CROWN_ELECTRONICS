<aside class="navbar-aside shadow-sm" id="offcanvas_aside">
    ...
    <nav>
        <ul class="menu-aside">
            ...
            <li
                class="menu-item has-submenu <?php echo e(request()->is('admin/products*') || request()->is('admin/add_products*') || request()->is('admin/categories*') ? 'active' : ''); ?>">
                <a class="menu-link" href="#">
                    <i class="icon material-icons md-shopping_bag"></i>
                    <span class="text">Products</span>
                </a>
                <div
                    class="submenu <?php echo e(request()->is('admin/products*') || request()->is('admin/add_products*') || request()->is('admin/categories*') ? 'show' : ''); ?>">
                    <a href="<?php echo e(route('products_list')); ?>"
                        class="<?php echo e(request()->is('admin/products') ? 'active' : ''); ?>">
                        Product List
                    </a>
            ...
            <li
                class="menu-item has-submenu <?php echo e(request()->is('admin/affiliate*') || request()->is('admin/affiliate_rules*') || request()->is('admin/affiliate_withdrawals*') ? 'active' : ''); ?>">
                <a class="menu-link" href="#">
                    <i class="icon material-icons md-share"></i>
                    <span class="text">Affiliate</span>
                </a>
                <div
                    class="submenu <?php echo e(request()->is('admin/affiliate*') || request()->is('admin/affiliate_rules*') || request()->is('admin/affiliate_withdrawals*') ? 'show' : ''); ?>">
                    <a href="<?php echo e(route('affiliate_customers')); ?>"
                        class="<?php echo e(request()->is('admin/affiliate_customers') ? 'active' : ''); ?>">
                        Affiliate Customers
                    </a>
                    <a href="<?php echo e(route('affiliate_rules')); ?>"
                        class="<?php echo e(request()->is('admin/affiliate_rules') ? 'active' : ''); ?>">
                        Affiliate Rules
                    </a>
                    <a href="<?php echo e(route('affiliate_withdrawals')); ?>"
                        class="<?php echo e(request()->is('admin/affiliate_withdrawals') ? 'active' : ''); ?>">
            ...
            <li
                class="menu-item has-submenu <?php echo e(request()->is('admin/vendors*') || request()->is('admin/payments*') ? 'active' : ''); ?>">
                <a class="menu-link" href="#">
                    <i class="icon material-icons md-store"></i>
                    <span class="text">Vendors</span>
                </a>
                <div
                    class="submenu <?php echo e(request()->is('admin/vendors*') || request()->is('admin/payments*') ? 'show' : ''); ?>">
                    <a href="<?php echo e(route('vendors')); ?>" class="<?php echo e(request()->is('admin/vendors') ? 'active' : ''); ?>">
                        Vendors
                    </a>
                    <a href="<?php echo e(route('admin.vendor.payments')); ?>"
                        class="<?php echo e(request()->is('admin/payments') ? 'active' : ''); ?>">
                        Payment Requests
                    </a>
                </div>
            </li>
...
<?php /**PATH D:\Manulas Doc\Project\Intern\Project\CROWN_ELECTRONICS\CROWN_ELECTRONICS\resources\views/AdminDashboard/Sidebar.blade.php ENDPATH**/ ?>